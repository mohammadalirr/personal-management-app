        ...
        <>
            <Grid container sx={{ mt: 3 }}>
                ...
                <Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
                    <Box sx={{border:'solid 1px #00cc00', width:'20rem', borderRadius:'15px', pt:3, pb:3, m:'auto'}}>
                        ...
                        <FormControl>
                            ...
                            <Button variant="filled" sx={{backgroundColor:'#00cc00'}}>
                                ثبت
                            </Button>
...
export default EghtesadeNovinIn;